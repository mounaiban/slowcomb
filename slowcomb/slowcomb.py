    ...
    * r - The length of the terms derived from the combinatorial
    ...
    def _get_perm(self, ii):
        ...
        * ii - Internal Index of the permutation. Accepts int, 
        ...
        This dual-stage referencing process was devised to avoid
        unnecessary copies of _seq_src, especially when it is large,
        ...
        When the construction process is complete, out will contain
        a re-arranged version or subset of _seq_src.
        ...
        _get_comb_tree_path will therefore be (0, 2, 2, 0, 0). 
        ...
        Tree path is (0, 2, 2, 0, 0) throughout the process.
        Source sequence is ('heads', 'shoulders', 'knees', 'toes')

        Element zero in path:
        Current _seq_src_idxs: (-1, 0, 1, 2, 3)
        Pop _seq_src_idxs[0], get -1
    ...
    * This permutator was almost called PokiesPermutator, due to the
    ...
    def _get_perm(self, ii):
        ...
        * ii - Internal Index of the permutation. Accepts int, 
        ...
        elements in the permutator tree.
        ...
        Recall that our _src_seq is ('🍇', '🍈', '🍉')

        In this case, the output contains ('🍈','🍇','🍉')
